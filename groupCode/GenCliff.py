...
def unique_up_to_scalar(matrix):
    normalized_matrix = normalized_matrix = np.zeros_like(matrix, dtype=np.complex128)
...
if __name__ == '__main__':
	...
	#tree_2 = tree_gen('P',20,True)
	#tree_3 = tree_gen('H',20,False)
	#tree_4 = tree_gen('H',20,True)


	total = []
	#for tree in [tree_1,tree_2,tree_3,tree_4]:
	for i in range(20):
	    total += tree[i]
